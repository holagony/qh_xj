...
def returnWind_report(years,sta_ids,daily_df,r,data_dir):
    ...
    #%% Part 1
    dic['element_title']='风速极值推算'
    dic['element_subtitle_1']='最大风速极值推算'
    ...
    #%% Part 2
    dic['element_subtitle_2']='极大风速极值推算'
    inst_data=pd.DataFrame(r['main_return_result']['max_values_i'])
    ...
    doc.render(dic)
    # 保存结果到新的docx文件
    report=os.path.join(data_dir,'RETURN_WIND.docx')
    doc.save(report)
