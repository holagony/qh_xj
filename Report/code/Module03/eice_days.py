# -*- coding: utf-8 -*-
"""
Created on Fri Jun 20 09:57:54 2025
...
def eice_days_report(table1,table2,table3,month_data,data_dir,main_sta_ids):

    if not os.path.exists(data_dir):
        os.makedirs(data_dir)
        
    doc_path=os.path.join(cfg['report']['template'],'Module03','EICE_Days.docx')
    ...
    doc.render(dic)
    # 保存结果到新的docx文件
    report=os.path.join(data_dir,'EICE_DAYS.docx')
    doc.save(report)
