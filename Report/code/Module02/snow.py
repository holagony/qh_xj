...
def snow_report(basic_snow_yearly,basic_snow_accum,post_yearly_df,data_dir):
    ...
    r, p, passed = pearson_r_sig(valid_snowperatures, y_fit, alpha=0.05)
    ...
    average_snow_picture_hournum=plot_picture(basic_snow_yearly, '年份','最大雪深(cm)','最大雪深（cm）','cm','历年最大雪深变化.png',2,2,data_dir,R=dic.get('average_R'))
