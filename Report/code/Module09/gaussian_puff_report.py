# -*- coding: utf-8 -*-
"""
Created on Mon Jul 29 14:49:19 2024
...
def gaussian_puff_report(result_dict,result_dict_3d, lon, lat, q, h, wind_s, wind_d, z1,  t, delt_tt,data_dir):

    if not os.path.exists(data_dir):
        os.makedirs(data_dir)
        
    doc_path=os.path.join(cfg['report']['template'],'Module09','gaussian_puff_report.docx')
    ...
    doc.render(dic)
    # 保存结果到新的docx文件
    report=os.path.join(data_dir,'gaussian_puff_report.docx')
    doc.save(report)
